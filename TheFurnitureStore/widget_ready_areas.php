...
if (is_home()) { 
	...
	if ($OPTION['wps_front_sidebar_disable'] != TRUE) {
		...
		$the_div_class 	= 'sidebar frontPage_sidebar noprint front-widgets alignright'; ?>
		...
		if ( is_sidebar_active('about_page_widget_area') || is_sidebar_active('contact_page_widget_area') || is_sidebar_active('search_widget_area') || is_sidebar_active('sub_customer_service_widget_area') || is_sidebar_active('page_widget_area') ||($children)){ ?>
			<div class="sidebar page_sidebar noprint <?php echo $the_float_class;?>">
				<div class="padding">
					...
					//search results
					elseif (is_page($OPTION['wps_search_results_page']) || is_page($OPTION['wps_reserved_bags_page']) || $post->post_name == 'allcats' || $show_widget == true) { if ( is_sidebar_active('search_widget_area') ) : dynamic_sidebar('search_widget_area'); endif;}

					elseif ($show_widget == true) { if ( is_sidebar_active('search_widget_area') ) : dynamic_sidebar('search_widget_area'); endif;}
