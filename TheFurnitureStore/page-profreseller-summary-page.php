	...
	<div id="items-tab" class="tab-content">
		<div class="category-bar">
			<ul class="category-items inner">
				...
				<li<?php if ($pscat == 'clothing') { echo ' class="active"'; } ?>><a href="<?php the_permalink(); ?>?seller=<?php echo $seller_id; ?>&scat=clothing" rel="ps">Clothing<?php if ($psellers_cat_nums['clothing'] > 0) { ?> <span class="num"><?php echo $psellers_cat_nums['clothing']; ?></span><?php } ?></a></li>
