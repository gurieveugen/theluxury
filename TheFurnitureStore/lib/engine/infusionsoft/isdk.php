...
class iSDK
{
     ...
     */
    public function cfgCon()
    {
		global $OPTION;
        $this->debug = 'off';

		$this->appname = $OPTION['wps_infusionsoft_api_name'];
		$this->key = $OPTION['wps_infusionsoft_api_key'];

        $this->client = new xmlrpc_client("https://$this->appname.infusionsoft.com/api/xmlrpc");
