...
$args['s'] = isset($_GET['s']) && $_GET['s'] != '' ? $_GET['s'] : '';
...
$GLOBALS['filter']['all_display_categories'] = getEachBlock($args);
$GLOBALS['filter']['hidden_terms']           = getHidedTerms($args);
...
$json['categories']   = (isset($GLOBALS['filter']['all_display_categories'])) ? $GLOBALS['filter']['all_display_categories'] : '{}';
$json['args']         = clearArgs($args);
$json['hash']         = http_build_query(clearArgs($GLOBALS['filter']['args']));
$json['hidden_terms'] = (isset($GLOBALS['filter']['hidden_terms'])) ? $GLOBALS['filter']['hidden_terms'] : '';
