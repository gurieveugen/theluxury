...
if($AUTHN_DATA['status'] == "Success")
{
	...
	echo "<dd>".__('Order Amount:','wpShop')." $AUTHN_DATA[amount] USD</dd>\n";
	echo "<dd>".__('Transaction Id:','wpShop')." $AUTHN_DATA[txn_id] </dd></dl>\n\n";
...
else if($AUTHN_DATA['status'] == 'Failed'){ echo 'Your transaction is failed. Please ensure that your account have enough balance. ';}
