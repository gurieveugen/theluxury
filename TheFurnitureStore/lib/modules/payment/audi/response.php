...
$AUTHN_DATA = audi_response();

	if($AUTHN_DATA['status'] == "0")
	{
			...
			echo "<dd>".__('Transaction Id:','wpShop')." $AUTHN_DATA[txn_id]</dd>\n";			
			echo "<dd>".__('Order Amount:','wpShop')." ".format_price($AUTHN_DATA[amount])." USD</dd></dl>\n\n";
