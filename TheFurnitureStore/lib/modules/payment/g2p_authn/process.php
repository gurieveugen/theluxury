...
//print_r($feedback);
$AUTHN_DATA = direct_response($feedback);
...
else{ echo 'Your transaction is failed. Please ensure that your account have enough balance. ';}
?>
...
sale.setOrderID('<?=$AUTHN_DATA['tracking_id']?>');
sale.setProductID('<?=$AUTHN_DATA['itemname']?>');
